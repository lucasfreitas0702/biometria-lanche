...
function validateRegisterForm() {
    ...
    elements.biometricBtn.disabled = false; // Sempre habilitado para permitir o registro
    elements.saveUserBtn.disabled = !hasPassword || !hasImage || !hasBiometric;
}

// Verificar disponibilidade biométrica
// A verificação de disponibilidade biométrica será feita no momento do registro, não desabilitando o botão inicialmente.
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    elements.registerBtn.addEventListener('click', () => {
        ...
        elements.registerScreen.classList.add('show-keypad'); // Mostra o teclado ao entrar na tela de registro
    });
    elements.backBtn.addEventListener('click', () => {
        switchScreen('main');
        elements.registerScreen.classList.remove('show-keypad'); // Esconde o teclado ao sair da tela de registro
    });

    // Mostrar/Esconder teclado na tela de registro ao focar/desfocar o input de senha
    elements.registerPasswordDots.addEventListener('click', () => {
        elements.registerScreen.classList.add('show-keypad');
    });

    // Esconder teclado quando o foco sai do input de senha (se necessário, pode ser ajustado)
    // document.addEventListener('click', (e) => {
    //     if (!elements.registerPasswordDots.contains(e.target) && !e.target.closest('.keypad')) {
    //         elements.registerScreen.classList.remove('show-keypad');
    //     }
    // });
