...
class WebAuthnHelper {
        ...
        try {
            ...
            const publicKeyCredentialCreationOptions = {
                ...
                authenticatorSelection: {
                    ...
                    requireResidentKey: true // Alterado para true para permitir múltiplas credenciais
                },
                timeout: 60000,
                attestation: "direct"
            };
    ...
    async authenticateCredential(credentialIds) {
        if (!this.isSupported) {
            throw new Error("WebAuthn não é suportado neste navegador");
        }
        ...
        try {
            ...
            crypto.getRandomValues(challenge);
                ...
                try {
                    ...
                    console.error('Erro ao decodificar credentialId:', id, e);
                    return null;
                }
